...
/**
  * @brief Unique ID Registers
  */

typedef struct
{
  __IO uint32_t D0;                /*!< Read protection register,               Address offset: 0x00 */
  __IO uint32_t D1;                /*!< Read protection register,               Address offset: 0x04 */
  uint32_t   RESERVED[3];          /*!< Reserved,                               0x08                 */
  __IO uint32_t D2;                /*!< Read protection register,               Address offset: 0x14 */
} UID_TypeDef;
...
#ifdef STM32L1XX_MD
#define UID_BASE              ((uint32_t)0x1FF80050) /*!< Unique ID base address */
#else
#define UID_BASE              ((uint32_t)0x1FF800D0) /*!< Unique ID base address */
#endif
