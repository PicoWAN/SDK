/*! \file
 \brief AES implementation that uses only 8-bit byte operations on the
 cipher state
...
/*!
 * \brief   Sets the key for AES encryption/decryption.
 *
 * \param   key The AES key to use.
 * \param   keylen The length of the key.
 * \param   ctx The current AES context.
 *
 * \retval  uint32_t 0 if everything went OK, -1 otherwise.
 */
...
/*!
 * \brief   Encrypts a single block of 16 bytes.
 *
 * \param   in The block to encrypt.
 * \param   out The buffer that will hold the encrypted block.
 * \param   ctx The current AES context.
 *
 * \retval  uint32_t 0 if everything is OK, -1 otherwise.
 */
...
/*!
 * \brief   Encrypts a buffer of n x 16 bytes.
 *
 * \param   in The buffer to encrypt.
 * \param   out The buffer that will hold the encrypted data.
...
/*!
 * \brief   Decrypts a single block of 16 bytes.
 *
 * \param   in The block to decrypt.
 * \param   out The buffer that will hold the decrypted block.
 * \param   ctx The current AES context.
 *
 * \retval  uint32_t 0 if everything is OK, -1 otherwise.
 */
...
/*!
 * \brief   Decrypts a buffer of n x 16 bytes.
 *
 * \param   in The block to decrypt.
 * \param   out The buffer that will hold the decrypted block.
 * \param   len The length of the buffer.
